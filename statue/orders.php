...
<section class="text-gray-700 body-font overflow-hidden">
  <div class="container px-5 py-24 mx-auto">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900" style="font-weight: bold;">Orders</h1>
    </div>
      ...
      <ul class="list-unstyled">
                <li></li>
                  <ul>
                     ...
                     <li class="list-group-item"> <a href="../documents/Orders/Order dated 20-12-2019.pdf" target="_blank" class="text-primary">Order dated 20-12-2019</a> <span class="badge badge-pill blink badge-warning">New</span></li>
                     
                     <li class="list-group-item"> <a href="../documents/Orders/Order dated 26-06-19 S.O. No. 2133(E).pdf" target="_blank" class="text-primary">Order dated 26-06-19 S.O. No. 2133(E)</a></li>

                     <li class="list-group-item"> <a href="../documents/Orders/Order dated 30-11-18.pdf" target="_blank" class="text-primary">Order dated 30-11-18 </a></li>

                     <li class="list-group-item"> <a href="../documents/Orders/Jute and Jute Textiles Control Order of 4th Feb 2016.pdf" target="_blank" class="text-primary">Jute and Jute Textiles Control Order of 4th Feb 2016 </a></li>

                      <li class="list-group-item"> <a href="../documents/Orders/Notification under JPM Act dated 27th August 2010.pdf" target="_blank" class="text-primary">Notification under JPM Act dated 27th August 2010 </a></li>
                                  
                  <li class="list-group-item"> <a href="../documents/Orders/Notification for withdrawal of minimum price dated 7th July 2006.pdf" target="_blank" class="text-primary">Notification for withdrawal of minimum price dated 7th July 2006 </a></li>
                  
                  <li class="list-group-item"> <a href="../documents/Orders/Raw Jute Control Order for Traders No. Jute (Mktg.)-45-2005 dated 26-12-2005.pdf" target="_blank" class="text-primary">Raw Jute Control Order for Traders No. Jute (Mktg.)/45/2005 dated 26-12-2005 </a></li>
                  
                  <li class="list-group-item"> <a href="../documents/Orders/Raw Jute Control Order No. Jute (Mktg.)-46-2005 dated 23-12-2005.pdf" target="_blank" class="text-primary">Raw Jute Control Order No. Jute (Mktg.)/46/2005 dated 23-12-2005 </a></li>
                  
                  <li class="list-group-item"> <a href="../documents/Orders/Reasonable Price Notification S. O. 1746 (E) dated 12-12-2005.pdf" target="_blank" class="text-primary">Reasonable Price Notification S. O. 1746 (E) dated 12-12-2005 </a></li>

                                            
                  
                  <li class="list-group-item"> <a href="../documents/Orders/Jute &amp; Jute Textile Control ( Amendment ) ORDER 2005.pdf" target="_blank" class="text-primary">Jute &amp; Jute Textile Control ( Amendment ) ORDER 2005 </a></li>

                  <li class="list-group-item"> <a href="../documents/Orders/Jute &amp; Jute Textile Control ( Amendment ) ORDER of 9th November 2005.pdf" target="_blank" class="text-primary">Jute &amp; Jute Textile Control ( Amendment ) ORDER of 9th November 2005 </a></li>

                  <li class="list-group-item"> <a href="../documents/Orders/Mandatory Jute Packaging ORDER of 28th September, 2004.pdf" target="_blank" class="text-primary">Mandatory Jute Packaging ORDER of 28th September, 2004</a></li>

                  <li class="list-group-item"> <a href="../documents/Orders/Jute &amp; Jute Textile Control ( Amendment ) ORDER 2002.pdf" target="_blank" class="text-primary">Jute &amp; Jute Textile Control ( Amendment ) ORDER 2002 </a></li>

                  
                  <li class="list-group-item"> <a href="../documents/Orders/Jute Bags Marking Order of 4th July, 2002.pdf" target="_blank" class="text-primary">Jute Bags Marking Order of 4th July, 2002</a></li>

                  <li class="list-group-item"> <a href="../documents/Orders/Jute Batching Oil Order of 28th August 2001.pdf" target="_blank" class="text-primary">Jute Batching Oil Order of 28th August 2001</a></li>

                   <li class="list-group-item"> <a href="../documents/Orders/Jute &amp; Jute Textiles Control ORDER OF 19th April 2000.(Now repeal &amp; replaced with jute &amp; Jute Textiles Control Order of 4th Feb,2016.pdf" target="_blank" class="text-primary">Jute &amp; Jute Textiles Control ORDER OF 19th April 2000.(Now repeal &amp; replaced with jute &amp; Jute Textiles Control Order of 4th Feb,2016 </a></li>

                  <li class="list-group-item"> <a href="../documents/Orders/Powers under Jute Packaging Act ORDER of 26th August 1987.pdf" target="_blank" class="text-primary">Powers under Jute Packaging Act ORDER of 26th August 1987</a></li>
