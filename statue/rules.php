...
<section class="text-gray-700 body-font overflow-hidden">
  <div class="container px-5 py-24 mx-auto">
    <div class="-my-8">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900" style="font-weight: bold;">Rules</h1>
    </div>
        
        <div class="md:flex-grow">
         
          
          <a class="text-indigo-500 inline-flex items-center mt-4" href="..\documents\rules\JMDC Procedural Rules 1984.pdf" target="_blank" style="font-weight: bold; font-size: 90%;">JMDC Procedural Rules 1984
      ...
      <div class="py-8 flex border-t-2 border-gray-200 flex-wrap md:flex-no-wrap">
        ...
        <div class="md:flex-grow">
          ...
          <a class="text-indigo-500 inline-flex items-center mt-4" href="..\documents\rules\Jute Packaging Materials Rules of 26th August 1987.pdf" target="_blank" style="font-weight: bold; font-size: 90%;"  >Jute Packaging Materials Rules of 26th August 1987
