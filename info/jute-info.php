...
<div class="modal fade" id="admin-panel-modal" tabindex="-1" role="dialog" aria-labelledby="admin-panel-modal" aria-hidden="true" style="margin-top: 5%;">
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <h3 style="font-weight: bolder;">Important regions/ zones for Jute cultivation in India</h3><br>

      <p class="leading-relaxed text-lg" style="text-align: left;">Jute cultivation is mainly concentrated in the eastern and north eastern India while that of mesta cultivation is spread almost throughout the country. The crop can be grown in low, medium and high land situation, both moisture stress and water stagnating condition. White Jute can be grown comparatively in low land situation while that of Tossa Jute prefers medium and high land situation. Mesta is grown in almost all over the country. It being a hardy crop and can tolerate moisture stress; its cultivation is spread in different agro-climatic situations unlike jute which is concentrated only in eastern and north eastern States. In a major part of Jute area, particularly in North Bengal, Bihar and North-Eastern States, the soil is acidic in nature. However, the Jute crop is growing in these areas in existing situation adjusting the crop sequence.</p><br><br>

      
      <img src="..\image\jute-india-map.gif">
  ...
  <tbody>
    <tr>
      ...
      <td class="border px-4 py-2">West Bengal</td>
      <td class="border px-4 py-2">577.0</td>
      <td class="border px-4 py-2">8349</td>

    </tr>

    <tr>
      <td class="border px-4 py-2">2</td>
      <td class="border px-4 py-2">Bihar</td>
      <td class="border px-4 py-2">139.1</td>
      <td class="border px-4 py-2">1690</td>

    </tr>

    <tr>
      <td class="border px-4 py-2">3</td>
      <td class="border px-4 py-2">Assam</td>
      <td class="border px-4 py-2">70.0</td>
      <td class="border px-4 py-2">823<td>

    </tr>

    <tr>
      <td class="border px-4 py-2">4</td>
      <td class="border px-4 py-2">Andhra Pradesh</td>
      <td class="border px-4 py-2">25.0</td>
    ...
    <tr>
      ...
      <td class="border px-4 py-2">Orissa</td>
      <td class="border px-4 py-2">22.4</td>
      <td class="border px-4 py-2">177.7</td>

    </tr>

    <tr>
      <td class="border px-4 py-2">6</td>
      <td class="border px-4 py-2">Meghalaya</td>
      <td class="border px-4 py-2">12.6</td>
      <td class="border px-4 py-2">86.31</td>

    </tr>

    <tr>
      <td class="border px-4 py-2">7</td>
      <td class="border px-4 py-2">Nagaland</td>
      <td class="border px-4 py-2">4.6</td>
      <td class="border px-4 py-2">40.2</td>

    </tr>

    <tr>
      <td class="border px-4 py-2">8</td>
      <td class="border px-4 py-2">Tripura</td>
    ...
    <tr>
      ...
      <td class="border px-4 py-2">Uttar Pradesh</td>
    ...
    <tr>
      ...
      <td class="border px-4 py-2">20.0</td>
      ...
      <h2 class="text-gray-900 font-medium title-font tracking-wider text-sm">(A = Area IN '000 Hect.; P = Prod. In '000 bales of 180 k.g per bale ; PY = Productivity in QTLS / Hect.)</h2>
      <p class="text-gray-500">Last Updated on: May 26, 2020</p>
    </div>
  </div>
</section>
